$(document).ready(function(){
	...
	// //Debug ColapseFunc
	// verificaBox = false;
	// $('.boxes-formacao a.box2-pad').each(function(){
	// 	if( !($(this).hasClass('display')) && verificaBox == false ){
	...
	// verificaBox2 = false;
	// $('.colapse-boxes .box ').each(function(){

	// 	if( !($(this).hasClass('display')) && verificaBox2 == false ){
	// 		$(this).addClass('active');
	// 		verificaBox2 = true;
	// 	}
	// });

	// SelectOptionColapseDebug = 0;
	// $('.colapse-formacao .select-colapse-mob option').each(function(){
	// 	console.log(this);
	// 	var valueItem = $(this).val();
	// 	if( !($(this).hasClass('display')) ){
	// 		SelectOptionColapseDebug++;
	// 		if(SelectOptionColapseDebug == 1){
	// 			$('.colapse-formacao .select-colapse-mob').val(valueItem);
	// 		}
	// 	}
	// })
